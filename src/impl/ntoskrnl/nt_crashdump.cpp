...
static void handle_capture_persistent_thread_state(const std::shared_ptr<emulator_t>& emulator,
	emulator_t::address_type context_address, emulator_t::address_type thread_address,
	std::uint32_t bugcheck_code, std::uint64_t bugcheck_param1,
	std::uint64_t bugcheck_param2, std::uint64_t bugcheck_param3,
	std::uint64_t bugcheck_param4, emulator_t::address_type output_address)
{
...
{
	redirect_handler<handle_capture_persistent_thread_state>(emulator, mapped_image, "KeCapturePersistentThreadState");
}
